...
| --- | --- | --- | --- | --- | --- |
| T14 V1.2 首轮记录与交回清单 | Codex／当前模型切换后的精确 ID 与档位未由可核验接口暴露 | main `96fd823`；现有 T14 v0.2 | `chrome/t14-v12-record` | `docs/MEASUREMENT_PROTOCOL.md`、`review/chrome/T14/MEASUREMENT_RECORD.md`、本人任务登记及 `docs/handoffs/chrome.md` | IN_PROGRESS；使 V1.2 第 4B 节 Q01–Q11 与记录表/第一轮交回一致，剔除旧 6 点/四触点要求造成的歧义；不要求用户自行拆板、蜂鸣或上电。 |
