...
### Chrome 2026-09-23 T14 V1.2 执行表补齐

| 任务 | 平台／实际模型与档位 | 输入提交 | 分支 | 文件范围 | 状态／交接 |
| --- | --- | --- | --- | --- | --- |
| T14 V1.2 首轮记录与交回清单 | Codex／当前模型切换后的精确 ID 与档位未由可核验接口暴露 | main `96fd823`；现有 T14 v0.2 | `chrome/t14-v12-record` | `docs/MEASUREMENT_PROTOCOL.md`、`review/chrome/T14/MEASUREMENT_RECORD.md`、本人任务登记及 `docs/handoffs/chrome.md` | IN_REVIEW；[draft PR #55](https://github.com/ChromeTokyo/MosaicoKeyboard/pull/55) 已交：V1.2 Q01–Q11、左槽三视图与条件式清单；实物未到、AS-02/03/04 未关闭，G1 未放行。 |
