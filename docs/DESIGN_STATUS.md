...
| D-IF-04 | 模块板提案的 C9144 带罩公头与 V1.0 文档所列 C124406 母座未见厂家交叉配对保证；目标 V1.2 母座料号本身 unknown；CJT C239341/XFCN C492438 仅为可购样的裸弯公头候选 | 到货核母座料号、断电试插与 20 针通断；改 J1 料须重建封装/净空和尺寸链、重跑 G2，非作者复核后才选型 |
