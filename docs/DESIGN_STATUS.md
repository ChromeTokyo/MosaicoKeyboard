...
| J-IF-07 | [C4 官方模块补充](../review/chrome/straight-header-side-contact/C4_OFFICIAL_MODULE.md)：官方交互模块的公针插主机，对侧可见母座；若手柄也用母座则不能直接配接。BSP 对模块自身六路功能的分配与既定十键脚位有五路重叠，PCB 逐脚连通和电源网络未知 | 不把官方模块当方案 J 的已验证转接件；若研究新增公针对接/改板路径，先拿网表或实物无电通断、确认左右槽方向和十路线路，再重审装配/受力/供电，并交独立复核。C6 仍不得据此开画 |
