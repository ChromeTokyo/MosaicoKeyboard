...
| [C4 补充：官方交互模块](C4_OFFICIAL_MODULE.md) | 官方模块公针进主机、对侧可见母座；手柄母座与其不能直连；BSP 六路模块功能中五路与既定十键脚位重叠 | 官方 PCB 网表、外侧母座 pinout、电源额定未知；直接替代方案 J 不成立，改造属于新架构，待主控裁决和独立复核 |
...
需 Hiro/Grok 独立复核 C1 原厂图、C2 尺寸/配对、C3 新安全问题、C4 官方模块适用边界及电源边界；主控记录裁决和冻结。`docs/DESIGN_STATUS.md` 的 J-IF-01～07 是同步阻断登记。
